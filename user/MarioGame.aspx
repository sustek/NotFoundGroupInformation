<%@ Page Title="" Language="C#" MasterPageFile="~/user/User.Master" AutoEventWireup="true" CodeBehind="MarioGame.aspx.cs" Inherits="GameLab.user.MarioGame" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="icerik">
        <h2>MARIO BROS OYUNU</h2><br />
        <asp:Image ID="Image1" runat="server" ImageUrl="~/img/mariotanitim.jpg" />
