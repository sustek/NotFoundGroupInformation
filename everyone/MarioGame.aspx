<%@ Page Title="" Language="C#" MasterPageFile="~/everyone/Everyone.Master" AutoEventWireup="true" CodeBehind="MarioGame.aspx.cs" Inherits="GameLab.everyone.MarioGame" %>
    ...
    <div class="icerik">
        ...
        <div id="amazingslider-2" style="display:block;position:relative;margin:0 auto;">
            <ul class="amazingslider-slides" style="display:none;">
                <li><a href="#"><img src="../img/11.png" data-description="Başlama Ekranı" /></a>
                </li>
                <li><a href="#"><img src="../img/22.png" data-description="Oyun Sırası" /></a>
                </li>
                <li><a href="#"><img src="../img/33.png" data-description="Oyun Sırası" /></a>
                </li>
                <li><a href="#"><img src="../img/44.png" data-description="Kazanma Ekranı" /></a>
                </li>
                <li><a href="#"><img src="../img/55.png" data-description="Kaybetme Ekranı" /></a>
                </li>
            </ul>
            <ul class="amazingslider-thumbnails" style="display:none;">
                <li><img src="../img/11-tn.png" /></li>
                <li><img src="../img/22-tn.png" /></li>
                <li><img src="../img/33-tn.png" /></li>
                <li><img src="../img/44-tn.png" /></li>
                <li><img src="../img/55-tn.png" /></li>
            </ul>
        </div>
    </div>
        <br />
        ...
        <div style="float: left; width: 100%;">
            Yorum yapabilmek için oturum açmalısınız.<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/user/MarioGame.aspx">Oturum Aç</asp:HyperLink>
        </div>
